...
final class Heroicons
{
    ...
    private const PATHS = [
        ...
        'cloud' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15a4.5 4.5 0 0 0 4.5 4.5h10.5a4.5 4.5 0 0 0 .94-8.9A6.75 6.75 0 0 0 5.48 8.35 4.5 4.5 0 0 0 2.25 15Z"/>',
        'server-stack' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 4.5h16.5v4.5H3.75V4.5Zm0 10.5h16.5v4.5H3.75V15Zm2.25-8.25h.008v.008H6V6.75Zm0 10.5h.008v.008H6v-.008Z"/>',
        'bolt' => '<path stroke-linecap="round" stroke-linejoin="round" d="m13.5 2.25-9 12h8.25l-2.25 7.5 9-12h-8.25l2.25-7.5Z"/>',
    ...
    public static function render(string $name, string $cssClass = ''): string
    {
        ...
        return '<svg class="onesmtp-heroicon ' . esc_attr($cssClass) . '" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor" aria-hidden="true" focusable="false">' . $path . '</svg>';
    }
}
