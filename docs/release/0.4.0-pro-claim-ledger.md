...
| Mailgun provider-event ingestion is a candidate-only Pro workflow; bounce/complaint suppression remains excluded. | Candidate implementation (unreleased) | [PR #162](https://github.com/mehul0810/aculect-mail/pull/162) hardens URL validation; issue [#63](https://github.com/mehul0810/aculect-mail/issues/63) adds the signed Mailgun route, normalized site-local table, replay hash, retention, and encrypted signing-key setting on this issue branch. Issue [#64](https://github.com/mehul0810/aculect-mail/issues/64) remains open and is not implemented. | This PR's synthetic signed fixtures cover accepted-as-unknown, delivered, temporary/permanent failure, complaint, replay, privacy, and gate/transport rejection paths. Browser evidence covers the signing-key field only; no live provider secret or payload is used. |
