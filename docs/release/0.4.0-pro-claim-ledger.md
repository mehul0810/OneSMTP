...
- Candidate branch: `release/0.4.0`, live origin tip `c848ff5eb5c28427e8a01310ba964453d90e1662`.
...
| Mailgun provider-event ingestion is a candidate-only Pro workflow; bounce/complaint suppression remains excluded. | Candidate-shipped (unreleased) | [PR #162](https://github.com/mehul0810/aculect-mail/pull/162) hardens URL validation; issue [#63](https://github.com/mehul0810/aculect-mail/issues/63) adds the signed Mailgun route, normalized site-local table, atomic replay-token claim table, retention, and encrypted signing-key setting. Issue [#64](https://github.com/mehul0810/aculect-mail/issues/64) remains open and suppression enforcement is not implemented. | This PR's synthetic signed fixtures cover accepted-as-unknown, delivered, temporary/permanent failure, complaint, parent-signature, replay-token mutation/race, privacy, and gate/transport rejection paths. Browser evidence covers the HTTPS endpoint/setup guidance and signing-key field only; no live provider secret or payload is used. |
| Any claim that tracking, OAuth lifecycle, token refresh/revocation UX, or license activation/update is available. | Planned/excluded | Open issues [#40](https://github.com/mehul0810/aculect-mail/issues/40), [#50](https://github.com/mehul0810/aculect-mail/issues/50), [#51](https://github.com/mehul0810/aculect-mail/issues/51), and [#66](https://github.com/mehul0810/aculect-mail/issues/66). Suppression enforcement remains planned under [#64](https://github.com/mehul0810/aculect-mail/issues/64). | No shipped source, accepted docs, or merged PR proves these claims. |
...
This documentation PR captures fresh capability-panel and Mailgun setup pairs
in its validation run and commits the evidence under
`docs/admin/screenshots/issue-63/`. The synthetic fixture contains no provider
credentials, message content, recipients, payloads, or other secrets.

[![Pro capabilities panel at desktop width showing candidate provider event ingestion and suppression follow-up copy](../admin/screenshots/issue-63/provider-events-capabilities-desktop.png)](../admin/screenshots/issue-63/provider-events-capabilities-desktop.png)

*Figure 1. Desktop candidate panel: the Mailgun provider event-ingestion row is visible
with privacy-safe ingestion copy, while suppression enforcement remains a
separate follow-up.*

[![Pro capabilities panel at narrow mobile width showing wrapped copy without horizontal overflow](../admin/screenshots/issue-63/provider-events-capabilities-mobile.png)](../admin/screenshots/issue-63/provider-events-capabilities-mobile.png)

*Figure 2. Narrow candidate panel at 390px: capability copy wraps within the
viewport and does not expose provider credentials or event payloads.*
