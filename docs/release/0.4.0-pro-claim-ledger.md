...
- Candidate branch: `release/0.4.0`, live origin tip `1e8ea6ef6c6f0bab5b30900016f4a24d68031ec0`.
...
| Any claim that multisite management, tracking, OAuth lifecycle, token refresh/revocation UX, quota budgets, or license activation/update is available. | Planned/excluded | Open issues [#41](https://github.com/mehul0810/aculect-mail/issues/41), [#40](https://github.com/mehul0810/aculect-mail/issues/40), [#50](https://github.com/mehul0810/aculect-mail/issues/50), [#51](https://github.com/mehul0810/aculect-mail/issues/51), [#54](https://github.com/mehul0810/aculect-mail/issues/54), and [#66](https://github.com/mehul0810/aculect-mail/issues/66); `multisite_management` is reserved/planned. | No shipped source, accepted docs, or merged PR proves these claims. |
...
(routing), PR #157/#160 (analytics/reports), and PR #161 (retention/export).
Those paths are local ignored artifacts from the source PRs; this documentation
PR captures a fresh capability-panel pair in its own validation run:

- `output/playwright/issue-57-pro-capabilities-desktop.png` (1232×709)
- `output/playwright/issue-57-pro-capabilities-mobile.png` (342×1333)
