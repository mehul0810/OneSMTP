...
[![Pro capabilities panel at desktop width showing candidate provider events and suppression follow-up copy](../admin/screenshots/issue-63/provider-events-capabilities-desktop.png)](../admin/screenshots/issue-63/provider-events-capabilities-desktop.png)

*Figure 1. Desktop candidate panel: the Mailgun provider-events row is visible
