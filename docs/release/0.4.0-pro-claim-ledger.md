...
- Candidate branch: `release/0.4.0`, live origin tip `ad28abb1a2dbaf94e6d3fb26589560ce561c6d1d`.
...
| Any claim that tracking or license activation/update is available. | Planned/excluded | Open issues [#40](https://github.com/mehul0810/aculect-mail/issues/40) and [#66](https://github.com/mehul0810/aculect-mail/issues/66). | No shipped source, accepted docs, or merged PR proves these claims. |
