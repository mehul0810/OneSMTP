...
- Candidate branch: `release/0.4.0`, live origin tip `fcf92b2d508ff56f0b1215f99004d51a3bd118a4`.
...
| Any claim that tracking, OAuth lifecycle, token refresh/revocation UX, quota budgets, or license activation/update is available. | Planned/excluded | Open issues [#40](https://github.com/mehul0810/aculect-mail/issues/40), [#50](https://github.com/mehul0810/aculect-mail/issues/50), [#51](https://github.com/mehul0810/aculect-mail/issues/51), [#54](https://github.com/mehul0810/aculect-mail/issues/54), and [#66](https://github.com/mehul0810/aculect-mail/issues/66). `provider_events` remains reserved/planned for issues #63/#64. | No shipped source, accepted docs, or merged PR proves these claims. |
...
[![Pro capabilities panel at desktop width showing shipped candidate rows and an inert planned provider-events row](../admin/screenshots/issue-57/pro-capabilities-panel-desktop.png)](../admin/screenshots/issue-57/pro-capabilities-panel-desktop.png)

*Figure 1. Desktop candidate panel (1232×727): shipped rows are marked
“Available with Pro”; the planned provider-events row is disabled.*
...
*Figure 2. Narrow candidate panel (342×1369): copy wraps within the viewport
and planned controls remain inert.*
