...
- Candidate Mailgun webhook ingestion behind `provider_events`, with strict HTTPS/JSON bounds, five-minute timestamp skew, encrypted signing-key storage, durable replay hashing, normalized privacy-safe event records, and suppression enforcement explicitly deferred to #64.
